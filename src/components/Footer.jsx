...
const Footer = () => {
    return (
        <footer className="relative flex flex-wrap items-center justify-between pb-2 px-2">
            <div className="mx-auto container max-w-5xl bg-white px-4 py-2 rounded-b-xl">
                <hr className="my-6 border-gray-500 sm:mx-auto dark:border-gray-700 " />
                <div className="sm:flex sm:items-center sm:justify-between max-w-5xl mb-2">
